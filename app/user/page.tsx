    ...
    <div className="min-h-screen bg-gray-100 pt-4">
      ...
      <div className="sm:max-w-4xl sm:mx-auto w-full mt-24 p-6 bg-white rounded-xl shadow-md flex sm:flex-row flex-col gap-6 items-start border border-gray-200 ">
        ...
        <div className="text-gray-700">
          ...
          <p className="md:break-normal ">
            This page is dedicated to tracking user attendance. Participants are required to attend both in-person and live sessions consistently. If a user misses a live session, they will be marked as absent. Additionally, if a participant's overall attendance falls below 50%, they will be automatically removed from the bootcamps. so ensure you attend all sessions regularly to maintain your status.
          </p>
        </div>
      </div>
...
<p className="text-lg text-gray-700  text-blue-900 animate-bounce animate-pulse sm:w-1/2 w-3/4 mx-auto">Don't forget if your attendance falls below 50%, you will be automatically removed from the boot camp <a href='#' className='underline text-red-700 'onClick={attendanceDetail}>see your attendance information</a></p>
...
<footer>
        <p className='text-center text-white sm:p-10 p-5 bg-gray-700 font-bold text-xl'>{new Date().getFullYear()} &copy;Tech Club</p>
      </footer>
    </div>
  );
};
